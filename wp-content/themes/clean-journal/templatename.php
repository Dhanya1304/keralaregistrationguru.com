...
.advanced-search-section table, .advanced-search-section td, .advanced-search-section th {
	...
	.advanced-search-section.doc-section{
		margin-bottom:20px;
	}
	...
	<main id="main" class="site-main" role="main">
		...
		<?php
			...
			if ($conn->connect_error) {
                ...
                //echo "<pre>";print_r($result_limit);die;
			?>

			<div class="advanced-search-section doc-section">
                ...
                <table class="refined-search-table">
                    <tbody>
                        <!--<tr>
                            ...
                            <td rowspan="3" class="submit-btn-home"><button id="submit_doc_search">Submit</button></td>
                        </tr>
                        <tr>
                            <th>From</th>
                            <th>To</th>
			...
			<div style="overflow-x:auto;" id="record_holder_doc">
	...
	<script>
		...
		$(document).on('click','#submit_doc_search',function(){
            ...
            $.ajax({
			    url:"/home_search.php", 
			    method:'POST',
			    data : {document_number : __document_number,document_name : __document_name,relevant_number : __relevant_number,authority_name : __authority_name,subject_english : __subject_english,from_date : __from_doc_date,to_date : __to_doc_date,is_ajax:true},
