            ...
            <li>
                <div class="wpforo-list-item">
                    ...
                    <div class="wpforo-list-item-right" <?php if( !$instance['display_avatar'] ): ?> style="width:100%"<?php endif; ?>>
                        <p class="posttitle"><a href="<?php echo esc_url($topic_url) ?>"><?php echo esc_html($topic['title']) ?></a> - <a href="<?php echo esc_url($wpforo->member->profile_url($member)) ?>"><?php echo esc_html($member['display_name']) ?></a></p>
<!--                        <p class="postuser">, <span style="white-space:nowrap;"><?php esc_html(wpforo_date($topic['created'])) ?></span></p>-->
                    </div>
                    <div class="wpf-clear"></div>
                </div>
            </li>
