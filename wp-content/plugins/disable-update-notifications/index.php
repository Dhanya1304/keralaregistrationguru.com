...
function dwnSettings() {
    echo '<h3 class="mlw-header">Hide notifications and inline warnings Settings</h3><hr>';
    if(isset($_GET['msg'])) { 
...
<div class="fm-wrapper">
	<form name="fm_dwun" method="POST">
		...
		<p class="fm-footer">
		<input type="submit" name="publish" id="publish" class="button button-primary" value="Save Changes"></p>
	</form>
</div>
<?php
